        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-lg text-white/70 leading-relaxed">
              Join Semipack Malaysia Sdn Bhd and be part of a world-class semiconductor
              packaging company. Discover opportunities that match your talent.
            </p>
      ...
      <section className="bg-white border-b border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-border">
            {[
              { icon: Factory, value: "Nilai, N.S.", label: "Headquarters" },
              { icon: Cpu, value: "Semiconductor", label: "Industry" },
              { icon: Users, value: `${publishedJobs.length}`, label: "Open Positions" },
              { icon: Award, value: "ISO Certified", label: "Quality Standard" },
            ].map((stat) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-white/60 text-lg mb-3">
              Your Career. Your Journey. Start Here.
            </p>
            {company?.address && (
